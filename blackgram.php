...
<head>
    <title>Dhanlaxmi Traders - Product Listing Page</title>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">All crop's</a>
                            </li>
                           
                        </ul>
                    </div>
                </div>
				<!-- php code display product -->
				<div class="row">
	<?php
			$con=mysqli_connect('localhost','root','','APMC');
			$sql="SELECT * FROM pro where pnm='black gram'";
			if($result=mysqli_query($con,$sql))
		    {
				if(mysqli_num_rows($result)>0)
				{
					...
					echo "<div class='card mb-4 product-wap rounded-0'>
							...
							?>
                                <img class="card-img rounded-0 img-fluid" class="i1" src="./image/<?php echo $row['img']; ?>"/>
								<?php
                            ...
                            <div class='card-body'>
								<h1>$row[pnm]</h1>
                                <p class='text-center mb-0'><h4><b>Price :</b> Rs.$row[pri]</h4></p>
                            <h3>Description:</h3>
							<p>$row[des]</p>
                        </div>
                        </div>";

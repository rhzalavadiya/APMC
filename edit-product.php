...
<html lang="en">
  <head>
    ...
    <title>Dhanlaxmi Traders-Edit Product </title>
    <link
      rel="stylesheet"
        ...
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="" class="tm-edit-product-form" enctype="multipart/form-data" method="POST">
				  <div class="form-group mb-3">
                    ...
                    <input type="text" name="p_id" class="form-control validate" required />
                  </div>
                  <div class="form-group mb-3">
              ...
              <div class="col-12">
                <input type="submit" name="add" class="btn btn-primary btn-block text-uppercase" value="Update Product Now"/>
              </div>
            </form>
            </div>
          </div>
 ...
 //echo $folder;
		...
		if(isset ($_POST['add']))
		{
			$sql ="update pro set pnm='$nm',des='$ds',cat='$ct',pri=$price,img='$image' where pid=$id";
			mysqli_query($con, $sql);
			if (move_uploaded_file($tempname,'./image/'.$_FILES["uf"]["name"])) 
			{
				echo "<h3>  Image uploaded successfully!</h3>";
		?>
		 <!--img src="demo/<?php// echo $_FILES["uf"]["name"]; ?>"width="190px" height="190px"/> -->

...
<head>
    <title>Dhanlaxmi Traders - About Page</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    ...
                    <p>
                        <ul>
							<li>Owner Name :- Dineshbhai Nakrani</li>
							<li>Conatact No. :- 9825841250</li>
							<li>Email Id :- dinesh1256@gmail.com</li>
							<li>Address :- 96, New Market Yard, Savarkundala, Gujarat, India</li>
						</ul>
						Our Site Can Only Provide The Information About The Our Crops and Products....
                    </p>
                </div>
                <div class="col-md-4">
